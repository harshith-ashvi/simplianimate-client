...
import { DisplacementMapEffect } from "@/utils/imageEffects";

import { DisplacementMapEffectFormType } from "@/types/effectsOptions";

const DisplacementMapCanvas = ({
  width,
  height,
  formData,
  downloadFile,
    ...
    if (canvasRef.current !== null) {
      ...
      imagesRef.current = preloadImages(
        ...
        function (images) {
          ...
          const displacementEffect = new DisplacementMapEffect(
            context,
            image,
            newWidth,
            newHeight
...
export default DisplacementMapCanvas;
